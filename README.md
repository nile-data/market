...
- The name "Nile Data Marketplace" is also copyright protected and should be changed to the name of your market.
...
Nile Data Marketplace comes with prebuilt components for you to customize to cover GDPR requirements. Find additional information on how to use them below.
