...
<h1 align="center">Nile Data Marketplace</h1>
...
- The name "NILE" is also copyright protected and should be changed to the name of your market.
...
NILE also includes a number of advanced features that are suitable for an enterprise data market, such as:
...
NILE comes with prebuilt components for you to customize to cover GDPR requirements. Find additional information on how to use them below.
